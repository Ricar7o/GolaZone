...
premier.weeks.find_by_week_number(37).matches.create(home_team: astonvilla, away_team: chelsea, :match_time => Time.new(2013, 5, 11, 12, 45, 0, "+00:00"), leg: 0, home_odds: 0.0, draw_odds: 0.0, away_odds: 0.0, venue: astonvilla.home_field, final_result: "A", home_score: 1, away_score: 2)
premier.weeks.find_by_week_number(37).matches.create(home_team: stoke, away_team: spurs, match_time: Time.new(2013,5,12, 13, 30, 0, "+00:00"), leg: 0, home_odds: 0.0, draw_odds: 0.0, away_odds: 0.0, venue: stoke.home_field, final_result: "A", home_score: 1, away_score: 2)
premier.weeks.find_by_week_number(37).matches.create(home_team: sunderland, away_team: sotton, match_time: Time.new(2013,5,12, 15, 0, 0, "+00:00"), leg: 0, home_odds: 0.0, draw_odds: 0.0, away_odds: 0.0, venue: sunderland.home_field, final_result: "D", home_score: 1, away_score: 1)
premier.weeks.find_by_week_number(37).matches.create(home_team: qpr, away_team: newcastle, match_time: Time.new(2013,5,12, 15, 0, 0, "+00:00"), leg: 0, home_odds: 0.0, draw_odds: 0.0, away_odds: 0.0, venue: qpr.home_field, final_result: "A", home_score: 1, away_score: 2)
premier.weeks.find_by_week_number(37).matches.create(home_team: norwich, away_team: westbrom, match_time: Time.new(2013,5,12, 15, 0, 0, "+00:00"), leg: 0, home_odds: 0.0, draw_odds: 0.0, away_odds: 0.0, venue: norwich.home_field, final_result: "H", home_score: 4, away_score: 0)
premier.weeks.find_by_week_number(37).matches.create(home_team: fulham, away_team: liverpool, match_time: Time.new(2013,5,12, 15, 0, 0, "+00:00"), leg: 0, home_odds: 0.0, draw_odds: 0.0, away_odds: 0.0, venue: fulham.home_field, final_result: "A", home_score: 1, away_score: 3)
premier.weeks.find_by_week_number(37).matches.create(home_team: everton, away_team: westham, match_time: Time.new(2013,5,12, 15, 0, 0, "+00:00"), leg: 0, home_odds: 0.0, draw_odds: 0.0, away_odds: 0.0, venue: everton.home_field, final_result: "H", home_score: 2, away_score: 0)
premier.weeks.find_by_week_number(37).matches.create(home_team: manu, away_team: swansea, match_time: Time.new(2013,5,12, 16, 0, 0, "+00:00"), leg: 0, home_odds: 0.0, draw_odds: 0.0, away_odds: 0.0, venue: manu.home_field, final_result: "H", home_score: 2, away_score: 1)
premier.weeks.find_by_week_number(37).matches.create(home_team: arsenal, away_team: wigan, match_time: Time.new(2013,5,14, 19, 45, 0, "+00:00"), leg: 0, home_odds: 0.0, draw_odds: 0.0, away_odds: 0.0, venue: arsenal.home_field, final_result: "H", home_score: 4, away_score: 1)
premier.weeks.find_by_week_number(37).matches.create(home_team: reading, away_team: manc, match_time: Time.new(2013,5,14, 20, 0, 0, "+00:00"), leg: 0, home_odds: 0.0, draw_odds: 0.0, away_odds: 0.0, venue: reading.home_field, final_result: "A", home_score: 0, away_score: 2)
puts "Added Week 37"
